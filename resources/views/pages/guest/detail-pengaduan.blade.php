                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <span class="badge badge-success rounded-pill px-2 py-1">{{$item->category->name_category}}</span>
                                    </div>
                                    <span class="badge badge-warning text-white rounded-pill px-2 py-1">{{$item->status}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
