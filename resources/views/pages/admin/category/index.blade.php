                            ...
                            <tbody>
                                @foreach ($categories as $kategori)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('category.destroy', $kategori->id) }}" method="post" id="formDelete">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{ route('category.edit', $kategori->id) }}" class="btn btn-sm btn-warning"><span class="fa fa-edit"></span> Edit</a>
